...
public class Piece {
	 ...
	 * sides = an integer array with four elements representing four sides, each side holds one of 8 edges.
	...
	/* to construct a piece from four edges
	 * parameters: north = the north edge, east = the east edge, south = the south edge, west = the west edge
	 */
	...
	/* to construct a piece from an integer array of edges
	 * parameters: a = an array of edges
	 */
	public Piece(int[] a){
		sides = new int[4];
	...
	/* to get the edge of the piece
	 * parameters: direction = the edge direction
	 * returns the edge
	 */
	...
	/* to get the orientation of the piece
	...
	*/
	 ...
	 * parameters: rotations = the number of rotations
	 * 
	 */
