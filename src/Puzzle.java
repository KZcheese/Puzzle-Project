...
public class Puzzle {
	...
	// Find a permutation of unused pieces, if the permutation is a solution,
	// done;
	// Otherwise, reset board and try next permutation until all permutations
	// exhausted
	...
	// Recursively move across row, col to set fitted piece until no fitted
	// piece
